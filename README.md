...
| witness | `manuscript` node; abbreviation is unique within its OCP version; `witness` edge from reading/orphan reading; citation-only witnesses have `undefined_manuscript=1` |
